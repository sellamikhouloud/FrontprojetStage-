      ...
      <div className="flex items-center justify-between gap-3 max-[640px]:flex-wrap">
        <div className="flex items-center gap-2 flex-1 min-w-0 max-[640px]:w-full">
          <div className="min-w-0 w-full">
            ...
            <div className="mt-3 flex items-center text-[15px] text-[#374151] min-w-0">
        ...
        <div
          ...
          "
        >
          <div className="text-[15px] sm:text-[16px] md:text-[18px] text-[#1E1E1E] whitespace-nowrap max-[640px]:whitespace-normal">
